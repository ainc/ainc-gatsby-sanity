...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "By checking this box, this alumni will be featured on the bootcamp page. Ensure that a corresponding 'company logo' is included below.",
    },
    {
      name: "jobTitle",
      type: "string",
  ...
  orderings: [
    {
      ...
      by: [{ field: "class.date", direction: "desc" }],
    },
    {
      title: "Graduation Date (oldest first)",
      name: "graduationDateAsc",
      by: [{ field: "class.date", direction: "asc" }],
    },
  ],
};
