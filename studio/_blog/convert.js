...
fileNames.forEach((fileName) => {
  ...
  if (fileName.endsWith('.md')) {
    ...
    var json = [
      ...
      // {author: "Nick Such",id: "77584be7-eff9-4a01-a0c2-de0fa06eb3fb"},
  
      // {author: "Keith",id: "965750b5-0d33-460e-9429-1402c815a1e3"},
  
      
      // {author: "Awesome Inc Team", id: "b9c06bab-517e-483b-9a26-6030226d5fb9"},
      // // {author: "Steve Osowicz", id: "20e94f0a-9132-4783-835d-a58cb5605db8"},
      // {author: "Will",id: "4f6fc2c9-2980-4b68-9eb8-0b1b661dd194"}
...
{"_createdAt":"2023-06-22T16:43:42Z",id:"430a1574-9c08-45ab-9dba-8de283aa87e0","_rev":"yucl1s-sfm-ftl-7o7-b9mj1xg1q","_type":"blogAuthor","_updatedAt":"2023-06-22T16:43:42Z",author:"Jordan Weiter"},
  ...
  //  console.log("hihihih", frontmatter.reference)
    // Create an object with the extracted data
    const jsonData = {
      _type: "blog",
      date: frontmatter.date.toISOString().slice(0,10),
      author: authorString.split(',')[0].trim(),
      // reference: {_ref: '965750b5-0d33-460e-9429-1402c815a1e3'},
      ...
      // thumbnail: frontmatter.header_img,
      // thumbnail: {_sanityAsset: frontmatter.header_img, _type: "image"},
