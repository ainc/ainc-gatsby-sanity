          ...
          S.list()
            ...
            .items([
              ...
              S.listItem()
                ...
                .child(
                  S.documentTypeList("fiveAcrossWinners").title(
                    "5 Across Winners",
                  ),
                ),
              S.listItem()
          ...
          S.list()
            ...
            .items([
              S.listItem()
                ...
                .child(
                  S.documentTypeList("fellowshipPortfolio").title(
              ...
              S.listItem()
                ...
                .child(
                  S.documentTypeList("fellowshipSponsers").title(
                    "Fellowship Sponsors",
                  ),
                ),
              S.listItem()
              ...
              S.listItem()
                ...
                .schemaType("mentor")
                .child(
                  S.documentTypeList("mentor").title("Fellowship Mentors"),
                ),
            ]),
        ),
      /* AWESOME INC U */
          ...
          S.list()
            ...
            .items([
              ...
              S.listItem()
                ...
                .child(
                  S.documentTypeList("bootcampTestimonials").title(
              ...
              S.listItem()
                ...
                .child(
                  S.documentTypeList("bootcampGraduationStats").title(
                    "Bootcamp Graduation Stats",
                  ),
                ),
              S.listItem()
                ...
                .child(
                  S.documentTypeList("bootcampEmployers").title(
                    "Bootcamp Employers",
                  ),
                ),
              S.listItem()
                ...
                .child(
                  S.document()
                    .schemaType("bootcampProfileCard")
                    .documentId("2727d39e-c68b-47fc-9d1c-e654d24c4fc2")
                    .title("Profile Card"),
                ),
              S.listItem()
                ...
                .child(
                  S.documentTypeList("bootcampAlumni").title("Bootcamp Alumni"),
                ),
              S.listItem()
                .title("Bootcamp Class")
                .schemaType("bootcampClass")
                .child(
                  S.documentTypeList("bootcampClass").title("Bootcamp Class"),
                ),
              S.listItem()
                ...
                .child(
                  S.document()
                    .schemaType("bootcampProgramGuide")
                    .documentId("55173d5b-fb52-4f17-885e-85a82dee1c29")
                    .title("Program Guide"),
                ),
              S.listItem()
              ...
              S.listItem()
                ...
                .child(
                  S.document()
                    .schemaType("bootcampImageTestimonials")
                    .documentId("25fdef99-2753-44b1-b592-e4c1df0160b9")
                    .title("Bootcamp Image Testimonials"),
                ),
              S.listItem()
                .title("Bootcamp Employer Testimonials")
                .schemaType("alumniTestimonials")
                .child(
                  S.documentTypeList("alumniTestimonials").title(
                    "Bootcamp Employer Testimonials",
                  ),
                ),
            ]),
        ),
