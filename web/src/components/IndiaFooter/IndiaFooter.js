      ...
      <Container>
        <Row>
            ...
            <Row className={styles.firstColRow}>
              <ul className={styles.infoList}>
                ...
                <li>
                  ...
                  <a href="mailto:info_india@awesomeinc.org">
                    info_india@awesomeinc.org
                  </a>
                </li>
              </ul>
            </Row>
          ...
          <Col xs={6} sm={6} md={2}>
            ...
            <ul className={styles.infoList}>
              <li>
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSeXn05oQn5hM3egYp9czGxLd2kPZhcdvUhK0jDrwIc_4Bx5aw/viewform">
                  Week of Code
                </a>
              </li>
              <li>
                <a href="">
                  Coding Club <small>(Coming Soon)</small>
                </a>
              </li>
            </ul>
          </Col>
        ...
        <Row className={styles.bottomRow}>
          ...
          <Col>
            <ul class={styles.socialsInlineList}>
              <li>
                <a
                  href="https://www.linkedin.com/company/awesome-inc-india/"
