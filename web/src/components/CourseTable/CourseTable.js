    ...
    <table className="">
      ...
      {tableInfo.map((course) => (
        <tr>
          <td className={styles.cell}>
            <a href={course.node.courseLink}>
              {course.node.picture !== null ? (
                ...
                <Subtitle className="text--brand link--bright-red">
          ...
          <td className={styles.cell}>
            <h2>{course.node.format}</h2>
          </td>
          <td className={styles.cell}>
            <h2>{course.node.topics}</h2>
          </td>
          <td className={styles.cell}>
            <h2>{course.node.technologies}</h2>
          </td>
          <td className={styles.cell}>
            <h2>
          ...
          <td className={styles.cell}>
            <h2>{course.node.designedFor ? course.node.designedFor : ""}</h2>
          </td>
          <td className={styles.cell}>
            <BrandButton className="p-1">Application Closed</BrandButton>
          </td>
        </tr>
      ))}
    </table>
