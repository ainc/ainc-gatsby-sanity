...
const Newsletter = () => {
  ...
  return (
    <section style={{ backgroundColor: `#555` }}>
      <Title className="text-center text-uppercase text-white py-5">
        Sign up for Our Newsletter
      </Title>
      <div className="py-1">
        <BrandButton className="d-block mx-auto mb-5" onClick={handleShow}>
          Sign Up
        </BrandButton>
        <Modal
          show={show}
        ...
        >
          ...
          >
            ...
            <Modal.Body>
              <label for="First Name" className={styles.formGroup}>
                First Name
              </label>
              <input
              ...
              />
              <br />
              <label for="Last Name" className={styles.formGroup}>
                Last Name
              </label>
              <input
                class="form-control"
              ...
              <br />
              {/*<!--Email-->*/}
              <label for="Email Address" className={styles.formGroup}>
                Email Address
              </label>
              <input
                class="form-control"
              ...
              <br />
              {/*<!-- Phone -->*/}
              <label for="Company" className={styles.formGroup}>
                Phone
              </label>
              <input
                class="form-control"
              ...
              <div className="form-check">
                ...
                />
                <label
                  className={`${styles.formGroup} form-check-label`}
                  for="Checkbox_1"
                >
