      ...
      <Container>
        <Row>
          <Col>
            ...
            <a href='/idea'>
                <img className = 'd-block mx-auto w-50 m-5' src={LightbulbIcon} alt="Lightbulb Icon" />
              </a>
          ...
          <Col>
            <div className="h-100 my-5">
              <a href='/fellowship'>
                <img className = 'd-block mx-auto w-50 m-5' src={RocketIcon} alt="Rocket" />
              </a>
          ...
          <Col>
            <div className="h-100 my-5">
              <a href='https://www.entrepreneurhof.com/'>
                <img className = 'd-block mx-auto w-50 m-5' src={BookIcon} alt="Book" />
              </a>
