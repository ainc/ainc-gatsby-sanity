...
const SeeTheSpace = (props) => {
  const videoLinkSrc = "https://www.youtube.com/embed/QItnXb9IBd8?si=G_JyJeX3rcacXemU";
      ...
      <Row className="align-items-center">
        ...
        <Col xs={12} md={3} className="text-center mb-3 mb-md-0">
          <motion.div initial={{ opacity: 0}} animate={{ opacity: 1}} transition={{ delay: 0.5, duration: 1 }}>
            <h3 className={styles.videoTitle}>Learn more about what we offer</h3>
        ...
        <Col md={6} className="text-center justify-content-center d-none d-md-flex">
            <div className={styles.videoThumbnail}>
              <motion.div initial={{ opacity: 0}} animate={{ opacity: 1}} transition={{ delay: 0.5, duration: 1 }}>
                {/* Youtube Link */}
