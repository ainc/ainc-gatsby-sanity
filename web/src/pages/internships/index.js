      ...
      <div className={styles.pageWrap}>
          ...
          <Container fluid>
            <Row className={styles.headerSection}>
              <Col className="mt-5 offset-md-2">
                ...
                >
                  <Title className="text--big mt-5 fw-bold text-white">
                    Join Team Alpha
                  </Title>
                  <Subtitle className="text-uppercase text-white">
        ...
        <Container>
          <Row className="flex-column flex-sm-row my-5">
            ...
            >
              <StaticImage
                placeholder="blurred"
                src="../../images/team-alpha-coffee.jpg"
                alt="Team Alpha getting coffee"
              ...
              <div className={styles.teamAlphaBadge}>
                ...
                >
                  <StaticImage
                    placeholder="blurred"
                    src="../../images/Team_Alpha_Logo_Grey.png"
                    alt="Team alpha logo"
                  />
                </motion.div>
              </div>
            ...
            <Col className="my-3">
              <Title className="text--bright-red text-uppercase mt-md-5">
                What is Team Alpha?
              </Title>
              <p className="my-5" style={{ width: "65%" }}>
                Team Alpha, Awesome Inc's internship program, is an integral
                part of helping accomplish our mission to make Lexington a
                better place to live and work. Our goal is to equip each intern
                with skill sets while gaining real-world experience by working
                on one of four teams: web development, design, videography, and
                marketing.
              </p>
              <a href="#team">
                <BrandButton className="secondary mb-md-5">
                  Find your team
                </BrandButton>
              </a>
            </Col>
            ...
            <Row>
              <div className={styles.tbDiv}>
                ...
                <p className="text-center text-white">
                  Find the team that's right for you and join our list of
                  alumni.
                </p>
                <p
                ...
                >
                  (Some have gone on to work at places like Disney, Facebook,
                  Google, Spotify, and more!)
                </p>
              ...
              >
                ...
                <Col xs={12} md={6} lg={3} className="mb-4">
                  <div className={styles.tbDiv}>
                    ...
                    >
                      <div className={styles.imageWrapper}>
                        {/* base photo for the events tile */}
                        <StaticImage
                          placeholder="blurred"
                          className={`${styles.teamImages} d-none d-sm-block`}
                          style={{
        ...
        <Container className="mt-4">
          <Row className="mt-4 flex-column flex-sm-row">
            <Col className="mt-5 ">
              <Title
                className="text--bright-red text-uppercase mt-md-5 pt-md-5"
              ...
              <p
                className={`my-md-5`}
                style={{ textAlign: "right", marginLeft: "auto", width: "65%" }}
              >
                In addition to the free t-shirt and unlimited oreos, we'll
                provide you with an opportunity to improve your skills,
                portfolio, and network. Since 2009, Awesome Inc has built a work
                hard, play hard culture capable of accelerating you towards your
                definition of awesome. Our goal is to give you the best
                experience by helping you achieve your goals; whether that is
                getting into your dream school, working for your favorite
                company, or starting something of your own.
              </p>
            </Col>
            <Col className="d-flex align-items-center justify-content-center my-5 py-md-5">
              <StaticImage
                placeholder="blurred"
                src="../../images/garret-cam.jpg"
                alt="Team Alpha having fun"
                style={{ maxWidth: "550px" }}
                className="mt-lg-5 py-lg-4"
              />
            </Col>
          </Row>
        </Container>
          ...
          <Row className="flex-column flex-sm-row">
            <Col className="d-flex align-items-center justify-content-center my-md-5 py-md-5">
              ...
              >
                <StaticImage
                  placeholder="blurred"
                  src="../../images/team-alpha-5across.jpg"
                  alt="Team Alpha at 5Across"
            ...
            <Col className="mt-md-5 pt-md-5 text-left mx-md-5">
              <Title className="text-uppercase text-white">
                Who we're looking for
              </Title>
              <p className="text-white my-5" style={{ width: "65%" }}>
                High school, college, and graduate students that are eager,
                coachable, and a good fit for Awesome Inc's culture. This
                immersive experience in Lexington, KY typically lasts for 1-2
                semesters. To learn more about what our specific requirements
                are, click each team's profile above.
              </p>
              <a
                href="https://careers.awesomeinc.org/jobs/Careers/649925000000610353/Team-Alpha---Internship?source=CareerSite"
                target="_blank"
                rel="noopener noreferrer"
              >
                <BrandButton className="white--dark-text">
                  Apply Now
                </BrandButton>
              </a>
            </Col>
        ...
        <Container>
          <Row>
            <Title className="text-center mt-md-5 text-uppercase text--red">
              Intern Testimonials
            </Title>
          </Row>
        </Container>
        <div ref={testimonialCarouselRef}>
          <Carousel
            indicators={true}
            className={`${styles.carouselHeight} my-3`}
          >
        ...
        {alumniLogoSlides.length > 0 && (
          <Container fluid className={styles.alumniLogosSection}>
            <Row className="mb-4">
              <Col className="text-center">
                <Title className="text-center mt-5 text-uppercase text--red">
                  Where Our Interns Work
                </Title>
              </Col>
            </Row>
            <div ref={logoSliderRef} className="keen-slider">
              {alumniLogoSlides.map((slide, idx) => (
        ...
        <Container fluid>
          <Row
            className={`${styles.applySection} d-flex text-center align-items-center`}
          >
            <a
              href="https://careers.awesomeinc.org/jobs/Careers/649925000000610353/Team-Alpha---Internship?source=CareerSite"
              target="_blank"
        ...
        <section id="faq">
          <Container fluid style={{ backgroundColor: "#323232" }}>
            <Row className="text-center">
              <Title className="text-white text-uppercase mt-5">
        ...
        >
          <Container>
            <Row className="text-center">
              <Title className="text--bright-red text-uppercase mt-3">
                Meet our Team ALpha Managers
              </Title>
            </Row>
            <Row className="d-flex justify-content-center mt-3">
              {allTeamAlpha.map((node, i) => (
                <Col
                  ...
                  xl={4}
                  xxl={4}
                  className={`my-3 d-flex ${i < 3 ? `${styles[`customCol${(i % 3) + 1}`]}` : "justify-content-center"}`}
                  key={i}
                >
                  {" "}
                  {/*Applies conditional styling to the first three columns - do this because the profile card was not mind for 3 column rows in mind */}
                  <Profile
                    variant="two"
                    name={node.name}
            ...
            <Row>
              <Col style={{ textAlign: "right" }}>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <BrandButton className="my-3">
                    Add me to the fun bunch
                  </BrandButton>
                </a>
              </Col>
