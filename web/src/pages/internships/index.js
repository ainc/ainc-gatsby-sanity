        ...
        <Row className="flex-column flex-sm-row my-5">
          ...
          <Col className="my-3">
            ...
            <p className="my-5" style={{ width: "65%" }}>
              Team Alpha, Awesome Inc's internship program, is an integral part
              of helping accomplish our mission to make Lexington a better place
              to live and work. Our goal is to equip each intern with skill sets
              while gaining real-world experience by working on one of four
              teams: web development, design, videography, and marketing.
            </p>
            <a href="#team">
          ...
          <Row>
            <div className={styles.tbDiv}>
              ...
              <p className="text-center text-white">
                Find the team that's right for you and join our list of alumni.
              </p>
              <p
      ...
      <Container className="mt-4">
        <Row className="mt-4 flex-column flex-sm-row">
          <Col className="mt-5 ">
            ...
            >
              In addition to the free t-shirt and unlimited oreos, we'll provide
              you with an opportunity to improve your skills, portfolio, and
              network. Since 2009, Awesome Inc has built a work hard, play hard
              culture capable of accelerating you towards your definition of
              awesome. Our goal is to give you the best experience by helping
              you achieve your goals; whether that is getting into your dream
              school, working for your favorite company, or starting something
              of your own.
            </p>
          </Col>
        ...
        <Row className="flex-column flex-sm-row">
          ...
          <Col className="mt-md-5 pt-md-5 text-left mx-md-5">
            ...
            <p className="text-white my-5" style={{ width: "65%" }}>
              ...
              semesters. To learn more about what our specific requirements are,
              click each team's profile above.
            </p>
            <a
              href="https://careers.awesomeinc.org/jobs/Careers/649925000000610353/Team-Alpha---Internship?source=CareerSite"
              target="_blank"
