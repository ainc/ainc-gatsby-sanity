         ...
         <Col md={{span: 12}}>
            <Row>
              ...
              <Col md={{span: 6}} className='text-center'>
                <p className='mt-5 fw-bold'>The next step in your learn-to-code journey is to schedule an admissions interview with our team. You can schedule one below or look for an email from us.</p>
              ...
              <Col md={{span: 6}}>
                <p className='mt-5'>Thanks for your interest in Awesome Inc's Web Developer Bootcamp. Your application is submitted! To get a sense of what's next, check out this video from our admissions team!</p>
