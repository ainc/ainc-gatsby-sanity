        ...
        <IndiaLayout>
            <Container>
                ...
                <Row>
                    ...
                    <StaticImage className={styles.images} src='../../../images/india/bryce.jpeg' alt='Bryce Anderson'></StaticImage>
                    <p className='mt-2'>Bryce Anderson</p>
                    <p className='mb-4'>Bryce Anderson is an entrepreneur based in Lexington, KY (USA). He has founded multiple companies and currently runs 
                        ...
                        to spend more time there.</p>
                    </Col>
                    <Col sm={6} md={{span:5}} lg={{span:4, offset:1}}>
                    <StaticImage className={styles.images} src='../../../images/india/ashlin.jpeg' alt='Ashlin Mathews'></StaticImage>
                    <p className='mt-2'>Ashlin Mathews</p>
                    <p className='mb-4'>Ashlin is a Senior Software Engineer and has worked for Bloomberg LP for the past 11 years. He currently lives in Dallas, TX (USA) 
                        ...
                        help launch the Awesome Inc coding school in his home town.</p>
                    </Col>
                </Row>
            </Container>
        </IndiaLayout>
