            ...
            <section className={styles.topSection}>
                <Row className='h-100'>
                    <Col xs={9} sm={6} md={{ span: 6 }} lg={{ span: 4, offset: 0 }} xl={{ span: 3, offset: 1 }}>
                        ...
                        <Subtitle className={`mb-2 text-start ms-1 text-white ${styles.subtitle}`}><i>In Person Coding Courses for those 9 - 16</i></Subtitle>
        ...
        <Container className={styles.engaged}>
            <Row>
                ...
                <Col sm={{ offset: 2, span: 8 }} md={{ span: 5 }} lg={{ span: 4, offset: 1 }} xl={{ span: 4, offset: 1 }}>
                    ...
                    <Link href='/india/about'><BrandButton className='mb-3'>about us</BrandButton></Link> 
                </Col>
            </Row>
        </Container>
            ...
            <Row>
                <Col>
                    ...
                    <Link className='d-flex justify-content-center' href='/india/faq'>
                        <BrandButton className={styles.faqButton}>see our faqs</BrandButton>
                    </Link>
                </Col>
            </Row>
        </Container>
