            ...
            <Col className='mt-5' xl={{span: 10, offset: 1}}>
                        <Accordion className='mb-5 pb-4' >
                            <AccordionItem eventKey="0">
                                ...
                                <AccordionBody>Yes, your child will need to bring a laptop computer to the courses. This will allow them to work on projects at home if they wish to as well.</AccordionBody>
                            </AccordionItem>
                            <AccordionItem eventKey="1">
                                <AccordionHeader><Badge className='my-3 me-2 rounded-circle' bg="danger" >2</Badge>Is Food Provided?</AccordionHeader>
                                <AccordionBody>Snacks and drinks will be provided but no meals will be provided. Students are also welcome to bring food if they wish</AccordionBody>
                            </AccordionItem>
                            <AccordionItem eventKey="2">
                                <AccordionHeader><Badge className='my-3 me-2 rounded-circle' bg="danger" >3</Badge>What is Awesome Inc?</AccordionHeader>
                                <AccordionBody>We exist to create and grow high tech startups. We do this by hosting community events, leading technology education courses, and offering a shared workspace environment. 
                                    ...
                                    in the United States.</AccordionBody>
                            </AccordionItem>
                            <AccordionItem eventKey="3">
                                ...
                                <AccordionBody><a className={styles.links} href='https://www.awesomeinc.org/india/about'>Click here</a> to meet the team.</AccordionBody>
                            </AccordionItem>
                            <AccordionItem eventKey="4">
                                ...
                                <AccordionBody>Yes. We believe face to face, in person training and education provides accountability, focus and is more fun which leads to greater results for students.</AccordionBody>
                            </AccordionItem>
                            <AccordionItem eventKey="5">
                                <AccordionHeader><Badge className='my-3 me-2 rounded-circle' bg="danger" >6</Badge>What's the Cost?</AccordionHeader>
                                <AccordionBody>Week of Code Program is 5000₹
                                    <br></br>
                                Coding Club Program (price coming soon)</AccordionBody>
                            </AccordionItem>
                        </Accordion>
                        </Col>
            </Container>
