      ...
      <Col lg={5} md={10}>
        <div className={`${styles.test}`}>
          ...
          <ul className={`${styles.Xmark} ${styles.stableList}`}>
            <li>Spaces marked for Carson's Restaurant (East Side of building)</li>
            <li>Spaces marked for Commerce Lexington, Northwestern Mutual or Awesome Inc Directors (West side of building)</li>
