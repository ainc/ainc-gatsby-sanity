        ...
        <Container>
            <Row className="justify-content-center flex-column flex-md-row" style={{marginTop: "150px", marginBottom: "40px"}}>
                <Col className={`d-flex flex-column justify-content-between ${styles.borderRight}  text-center`}>
                    ...
                    <a href="https://forms.zohopublic.com/virtualoffice9155/form/5AcrossApplication1/formperma/i3hM2QiFcJG1DM_nCW8jQvMplp5UUFgRbKc5Ev8kuiA" target="_blank">
                        <BrandButton className='secondary my-3'>Apply to pitch</BrandButton>
                    </a>
                </Col>
