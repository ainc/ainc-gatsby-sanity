...
const SalesforceApplyPage = ({}) => {
    return (
        <Layout>
            <Title className='text-center mt-3 mb-3'>SALESFORCE CAREER ACCELERATOR APPLICATION</Title>
            <div style={{display: 'flex', justifyContent: 'center',}}>
                <Subtitle className='px-lg-5 py-5' style={{textAlign: 'left', width: '55%', fontSize: '1.25rem'}}> HOME / LEARN / ADULTS / SALESFORCE / <span style={{color: '#a21b22'}}>APPLY</span></Subtitle>
            </div>
            ...
            <div class="form-group mt-3 mb-3" style={{display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center'}}>
    	        <label htmlFor="Lead Source" style={{textAlign: 'left', width: '49%'}}>How did you find out about this program?</label>
            ...
            <div class="form-group mb-3 mt-3" style={{display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center'}}>
    	        <label htmlFor="LEADCF26" style={{textAlign: 'left', width: '49%'}}>If referred, who told you about the program?</label>
            ...
            <Container> 
                <Row>
                    ...
                    <Row>
                        ...
                        <Row>
                            <Title className="text-center py-4 fs-3 text--large">Tuition</Title>
                        </Row>
                        <Row className="mx-5">
                            <p  style={{fontSize:"1rem"}} className="text-justify">
                            The Salesforce Career Accelerator is available to Kentucky residents for $3499.
                            </p>
                    </Row>
                        </Col>
                        <Col>
                        <Row className="me-5">
                            <Title className="text-center py-4 ms-3 text--large">Scholarship</Title>
                        </Row>
                        <Row className="mx-5">
                            <p style={{fontSize:"1rem"}} className="text-justify">
                            Residents of Lexington-Fayette County are eligible to apply for one of 20 annual scholarships provided through LFUCG / ARPA. This scholarship covers $2500 per trainee, reducing the out-of-pocket cost of the program to $999.
                            This program is being supported, in whole or in part, by federal award numbers SLFRP0292/SLFRP3418 awarded to Lexington-Fayette Urban County Government by the U.S. Department of Treasury.
                            </p>
                        </Row>
                        </Col>
                    </Row>
