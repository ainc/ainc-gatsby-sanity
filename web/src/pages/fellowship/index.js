    ...
    <Layout>
        ...
        <Row>
          ...
          <Col className="my-4" xs={12} sm={6}>
            <ImageOutline style={{ marginLeft: "1rem" }}>
              <StaticImage
                placeholder="blurred"
                src="../../images/fellowship_header.jpg"
                width={400}
                objectFit="cover"
      ...
      <Container className="my-5">
        <Row className="d-flex justify-content-center align-items-center flex-sm-column flex-md-row">
          ...
          <Col className="d-flex justify-content-center align-items-center py-2">
            <KPIBoxes
              className=""
              title={fellowshipKPIs.investmentRaised}
              subtitle=" Outside Investment Raised"
            />
          </Col>
          <Col className="d-flex justify-content-center align-items-center py-2">
            <KPIBoxes
        ...
        <Row className="my-5 justify-content-center">
          <Col xs={8} sm={6}>
            <a onClick={handleShow} id="video-btn" href="#!">
              <StaticImage
                placeholder="blurred"
                src="../../images/fellowship-video-macbook.png"
                className="position-relative"
                alt="Macbook with video"
              />
            </a>
            <ModalCustom
              lgShow={lgShow}
        ...
        <Row>
          <Col className="col-md-auto mr-5 text-center">
            ...
            <StaticImage
              ...
              alt="Fellowship approach diagram"
            />
          </Col>
          <Col className="d-flex align-items-center mx-5">
            <Container>
              <Row className="my-4">
                <Title className="fs-5" style={{ letterSpacing: "0rem" }}>
      ...
      <div className={`${styles.sponsorBackground} text-center pt-5 pb-1`}>
        <Col className="col-md-auto">
          ...
          >
            {" "}
            {/*Change the "col-sm-6" higher or lower to change total column width*/}
