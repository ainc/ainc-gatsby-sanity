...
const Page = ({ data }) => {
  ...
  return (
    <Layout>
      <section
        id="header"
        className={`d-flex align-items-center ${styles.headerSection}`}
      >
        <Container>
          <Col className="justify-conent-center text-center">
            ...
            <Title className="text-white py-3">
      ...
      <section id="Experience">
        <Container className="py-5">
          <Col className="text-center justify-content-center">
            ...
            <p className="px-5">
              Week of Code Camp is Designed for Children Ages 9-16, at Beginner
          ...
          <Row className={`d-flex align-items-center justify-content-center`}>
            ...
            <Col md={6} className={`${styles.reviewText}`}>
              ...
              <p className={`fw-bold text-white py-3 ${styles.reviewQuote}`}>
                “The way the classes are structured and the one-on-one attention
                the kids get from the teachers is amazing. My kids absolutely
                love these classes.”
              </p>
      ...
      <secton id="projects">
        <Container className={`${styles.projectSection} my-5 py-4`}>
          <Row>
            <Col
              md={4}
              className={`d-flex justify-content-center ${styles.projectCard}`}
            >
              <ProjectCard
                image={Devices}
                description={
            ...
            >
              <ProjectCard
                image={Microphone}
                description={
                  "PRACTICE YOUR PRESENTATION SKILLS AND SHOW YOUR PROJECT"
                }
              />
            </Col>
          </Row>
      ...
      <section id="moreThan" className={`${styles.moreThanSection}`}>
        <Container>
          <Col className="justify-conent-center text-center">
            ...
            >
              Week of Code boosts creativity, logical thinking skills, and brain
              power. The camp is kept small to ensure everyone gets focused
              attention.
            </p>
            <a
              href="https://www.eventbrite.com/e/week-of-code-summer-camp-1-june-9-12-level-1-awesome-inc-2025-tickets-1217094886569?aff=oddtdtcreator"
        ...
        <Container className="pb-5">
          <Col className="justify-conent-center text-center">
            ...
            <Col className="pb-3 d-none d-md-block">
              ...
              <h3>
                Certificate of Completion <p className="d-inline">•</p> Memories
                with New Friends!
              </h3>
            </Col>
            {/* Mobile Display */}
            ...
            <Row className={styles.pictures} style={{ padding: "auto" }}>
              <Col
                style={{ width: "60%", height: "100%", paddingRight: "5px" }}
              >
                <Image
                  src={MaskGroup8}
                  alt={"Group 8"}
          ...
          <Accordion className="mb-5">
            <Accordion.Item eventKey="0" className="px-3 py-4">
              ...
              <Accordion.Body style={{ textAlign: "left" }}>
                Free Parking is available for drop-off/pickup. The best location
                is the parking lot to the east side of our building, in spaces
                1-19. See{" "}
                <a
            ...
            <Accordion.Item eventKey="1" className="px-3 py-4">
              ...
              <Accordion.Body style={{ textAlign: "left" }}>
                ...
                the course. Either Microsoft Windows-based PC's, Apple macOS
                computers, and Chromebooks will work, but iPads will not work
                for this course. We recommend a laptop made within the past 3-4
                years. Computers should be free from viruses/malware. We have a
                limited number of{" "}
                <a
