      ...
      <section id="Experience">
        <Container className="py-5">
          <Col className="text-center justify-content-center">
            ...
            <p className="px-5">
              Week of Code Camp is Designed for Children Ages 9-16, at Beginner to Intermediate
              Levels
            </p>
        ...
        <Container>
          <Row className={`d-flex align-items-center justify-content-center`}>
            ...
            <Col md={6} className={`${styles.reviewText}`}>
              ...
              <p className={`fw-bold text-white py-3 ${styles.reviewQuote}`}>
                “The way the classes are structured and the one-on-one attention the kids get from
                the teachers is amazing. My kids absolutely love these classes.”
              </p>
        ...
        <Container className={`${styles.projectSection} my-5 py-4`}>
          <Row>
            <Col md={4} className={`d-flex justify-content-center ${styles.projectCard}`}>
              <ProjectCard
                image={Devices}
                description={"CREATE A VIDEO GAME, WEBSITE, AND A MOBILE APP IN ONE WEEK"}
              />
            </Col>
            <Col md={4} className={`d-flex justify-content-center ${styles.projectCard}`}>
              <ProjectCard
                image={Games}
                description={"ENJOY UNPLUGGED ACTIVITIES AND MAKE FRIENDS"}
              />
            </Col>
            <Col md={4} className={`d-flex justify-content-center ${styles.projectCard}`}>
              <ProjectCard
                image={Microphone}
                description={"PRACTICE YOUR PRESENTATION SKILLS AND SHOW YOUR PROJECT"}
              />
            </Col>
          </Row>
        </Container>
      ...
      <section id="moreThan" className={`${styles.moreThanSection}`}>
        <Container>
          <Col className="justify-conent-center text-center">
            ...
            <p className="py-4" style={{ width: "60%", margin: "auto", textAlign: "center" }}>
              Week of Code boosts creativity, logical thinking skills, and brain power. The camp is
              kept small to ensure everyone gets focused attention.
            </p>
            <a
              href="https://www.eventbrite.com/e/week-of-code-summer-camp-level-1-at-awesome-inc-2024-tickets-801830545747"
              target="_blank"
        ...
        <Container className="pb-5">
          <Col className="justify-conent-center text-center">
            ...
            <Col className="pb-3 d-none d-md-block">
              <h3>
                Project Files <p className="d-inline">•</p> Portfolio to Share{" "}
                <p className="d-inline">•</p> Week of Code T-Shirt
              </h3>
              <h3>
                Certificate of Completion <p className="d-inline">•</p> Memories with New Friends!
              </h3>
            </Col>
            {/* Mobile Display */}
            <Col className="d-block d-md-none pb-3">
              ...
              <Row>
                <h3>Portfolio to Share</h3>
              </Row>
              <Row>
                <h3>Week of Code T-Shirt</h3>
              </Row>
              <Row>
                <h3>Certificate of Completion</h3>
              </Row>
              <Row>
                <h3>Memories with New Friends!</h3>
              </Row>
            </Col>
            ...
            <Row className={styles.pictures} style={{ padding: "auto" }}>
              <Col style={{ width: "60%", height: "100%", paddingRight: "5px" }}>
                <Image
                  src={MaskGroup8}
                  alt={"Group 8"}
                  style={{ height: "50%", paddingBottom: "5px" }}
                  className={styles.galleryPhoto}
                />
                <Image
                  src={MaskGroup9}
                  alt={"Group 9"}
                  style={{ height: "50%", paddingTop: "5px" }}
                  className={styles.galleryPhoto}
                />
              </Col>
              <Col style={{ width: "40%", height: "100%", paddingLeft: "5px" }}>
                <Image
                  src={MaskGroup7}
                  alt={"Group 7"}
                  style={{ height: "70%", paddingBottom: "5px" }}
                  className={styles.galleryPhoto}
                />
                <Image
                  src={MaskGroup10}
                  alt={"Group 10"}
                  style={{ height: "30%", paddingTop: "5px" }}
                  className={styles.galleryPhoto}
                />
              </Col>
            </Row>
      ...
      <section id="FAQs" style={{ backgroundColor: "#ED3742" }}>
        <Container className={`text-center p-5`}>
          ...
          <Accordion className="mb-5">
            <Accordion.Item eventKey="0" className="px-3 py-4">
              ...
              <Accordion.Body style={{ textAlign: "left" }}>
                Free Parking is available for drop-off/pickup. The best location is the parking lot
                to the east side of our building, in spaces 1-19. See{" "}
                <a className="link--brand" href="http://www.awesomeinc.org/parking/">
                  parking map
                </a>{" "}
                for more details.
              </Accordion.Body>
            ...
            <Accordion.Item eventKey="1" className="px-3 py-4">
              ...
              <Accordion.Body style={{ textAlign: "left" }}>
                Yes, each student will need to provide his/her own laptop for the course. Either
                Microsoft Windows-based PC's, Apple macOS computers, and Chromebooks will work, but
                iPads will not work for this course. We recommend a laptop made within the past 3-4
                years. Computers should be free from viruses/malware. We have a limited number of{" "}
                <a
                  href="https://squareup.com/market/awesome-inc/laptop-rental"
                  className="link--brand"
                >
                  rental laptops available for $25/day.
                </a>
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="2" className="px-3 py-4">
              ...
              <Accordion.Body style={{ textAlign: "left" }}>
                Yes, we have scholarships available thanks to our sponsor, Verizon. You can{" "}
                <a href="https://goo.gl/forms/sZpc22S1jdeoZ7Fk2" className="link--brand">
                  apply here.
                </a>
              </Accordion.Body>
            </Accordion.Item>
          ...
          <p className="fst-italic text-white">
            Still have questions? Email us at learn@awesomeinc.org
          </p>
        </Container>
      </section>
    </Layout>
