      ...
      <Container>
        ...
        >
          ...
          <div className="form-group mt-3 mb-3">
            <label
              htmlFor="Lead Source"
              className="d-flex justify-content-left mx-1"
            >
        ...
        <Row className="d-flex justify-content-center align-items-center my-3">
          <Col className="d-flex justify-content-center align-items-center">
            <StaticImage
              placeholder="blurred"
              src="../../../../images/bootcamp/david.jpg"
              className="rounded-circle"
              style={{ width: "50px" }}
            />
            <StaticImage
              placeholder="blurred"
              src="../../../../images/bootcamp/brett.jpg"
              className="rounded-circle"
              style={{ width: "50px" }}
            />
            <StaticImage
              placeholder="blurred"
              src="../../../../images/bootcamp/melo.jpg"
              className="rounded-circle"
              style={{ width: "50px" }}
            />
          </Col>
