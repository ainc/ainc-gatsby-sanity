        ...
        <div className={styles.navContainer}>
            <nav aria-label="side-navigation">
                ...
                <li className="nav-item">
                    ...
                    <li className="nav-item">  
                    <a href="#learn-skills" className="nav-link text-uppercase text-body text--micro">What we offer</a>
                    </li>
                    <li className="nav-item">
                        <a href="#more-than-bootcamp" className="nav-link text-uppercase text-body text--micro">More than a bootcamp</a>
                    </li>
                    <li className="nav-item">
