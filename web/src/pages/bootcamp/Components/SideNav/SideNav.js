...
function SideNav() {
  useEffect(() => {
    const handleScroll = () => {
      ...
      const bootcampSectionPosition =
        bootcampSection.getBoundingClientRect().top;
      ...
      <nav aria-label="side-navigation">
        <ul className="nav flex-column">
          <li className="nav-item">
            <a
              href="#job-guarantee"
              className="nav-link text-uppercase text-body text--micro"
            >
              Job Guarantee
            </a>
          </li>
          ...
          <li className="nav-item">
            <a
              href="#header"
              className="nav-link text-uppercase fw-bold text-body text--micro"
            >
              Apply Now
            </a>
          </li>
