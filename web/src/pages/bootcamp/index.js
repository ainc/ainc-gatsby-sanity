...
const BootcampPage = (props) => {
  ...
  return (
    <Layout jsImport={ZohoSales}>
        ...
        <Container fluid className={`${styles.header} overflow-hidden`}>
          <Container>
            <Row className={`${styles.titleBlock} mt-5 d-flex`}>
              ...
              >
                <Row
                  className={`${styles.ratingContainer} d-none d-md-flex align-items-center mb-3`}
                >
      ...
      <Container>
        <Row>
          <Col className="col-1 d-none d-sm-block">
            {" "}
            {/* Hidden on mobile */}
            <SideNav />
          </Col>
            ...
            <Col className="d-flex justify-content-center">
              ...
              >
                <StaticImage
                  placeholder="blurred"
                  alt="Job Guarantee"
                  src="../../images/bootcamp/job-guaranteed.png"
        ...
        <Container fluid className={`${styles.twoButtons}`}>
          ...
          >
            <Col
              ...
              lg={5}
              xl={4}
              className={`${styles.leftButtonCol} text-center align-items-center`}
            >
              <motion.div
                initial={{ opacity: 0, y: -50 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <Col
              ...
              lg={5}
              xl={4}
              className={`${styles.rightButtonCol} text-center align-items-center`}
            >
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <Row className="">
                  <Title className="text-center py-2 fs-3 text--medium white">
                    Pay nothing until you land a job!
                  </Title>
                  <div>
                    <BrandButton
                      onClick={() => scrollToSection(sectionCost)}
        ...
        <Row className="d-flex justify-content-center align-items-center">
          ...
          <Col xs={12} className="text-center d-md-none">
            <div className={styles.videoThumbnail}>
              <a
                href="https://www.youtube.com/watch?v=xmZ6jVn0QWM"
                target="_blank"
              ...
              <div className={``}>
                <div className="d-flex justify-content-center">
                  ...
                  >
                    <StaticImage
                      placeholder="blurred"
                      src="../../images/bootcamp/Career-Coach.svg"
                      style={{ width: "100%" }}
                    />
                  </div>
                </div>
                <Title className="py-3 text-center" style={{ marginLeft: "" }}>
                  Access to full-time career coach for support&nbsp;24/7
                </Title>
                <p
              ...
              <div className={``}>
                <div className="d-flex justify-content-center">
                  ...
                  >
                    <StaticImage
                      placeholder="blurred"
                      src="../../images/bootcamp/In-Person-Learning.svg"
                      style={{ width: "100%" }}
                    />
                  </div>
                </div>
          ...
          <Col className={`${styles.gallery} mt-3`}>
            ...
            >
              ...
              <Image
                src={bootcamp3}
                alt={"Bootcamp 3"}
                style={{ width: "65%", paddingLeft: "5px" }}
                className={styles.galleryPhoto}
              />
            </Row>
            <Row
              ...
              <div className="overflow-hidden">
                <Slider {...settings} className="">
                  <div className="d-flex justify-content-center">
                    <StaticImage
                      placeholder="blurred"
                      src="../../images/bootcamp/languages/html.png"
                      alt="HTML"
                  ...
                  <div className=" d-flex justify-content-center">
                    <StaticImage
                      placeholder="blurred"
                      src="../../images/bootcamp/languages/css.png"
                      alt="CSS"
                      style={{ maxWidth: "150px" }}
                    />
                  </div>
                  <div className=" d-flex justify-content-center">
                    <StaticImage
                      placeholder="blurred"
                      src="../../images/bootcamp/languages/javascript.png"
                      alt="JavaScript"
                      style={{ maxWidth: "150px" }}
                    />
                  </div>
                  <div className="d-flex justify-content-center">
                    <StaticImage
                      placeholder="blurred"
                      src="https://d33wubrfki0l68.cloudfront.net/27b5922e90fa2d54a0c37d426870c849e8a41c72/b2845/assets/img/bootcamp/languages/python.png"
                  ...
                  <div className=" d-flex justify-content-center">
                    <StaticImage
                      placeholder="blurred"
                      src="../../images/bootcamp/languages/git.png"
                      alt="Git"
                      style={{ maxWidth: "150px" }}
                    />
                  </div>
                  <div className=" d-flex justify-content-center align-items-center">
                    <StaticImage
                      placeholder="blurred"
                      src="https://d33wubrfki0l68.cloudfront.net/4aa1ba4778ed686e1877a7c5ef5875e364033ca8/f7b05/assets/img/bootcamp/languages/django.png"
                  ...
                  <div className="d-flex justify-content-center">
                    <StaticImage
                      placeholder="blurred"
                      src="https://d33wubrfki0l68.cloudfront.net/ee9d2a6ac7c95e3ee2695ce7a14627abeb797b0f/4631a/assets/img/bootcamp/languages/react.png"
                      style={{ maxWidth: "150px" }}
                      alt="React Framework"
                    />
                  </div>
                  <div className="d-flex justify-content-center">
                    <StaticImage
                      placeholder="blurred"
                      src="../../images/bootcamp/languages/agile.png"
                      alt="Agile"
                      style={{ maxWidth: "150px" }}
                    />
                  </div>
        ...
        >
          ...
          <Col className={`${styles.applyCol} mb-5 justify-content-center`}>
            <div className={`d-flex justify-content-center`}>
              <StaticImage
                placeholder="blurred"
                alt="Bootcamp online application"
                src="../../images/bootcamp/online-application.png"
                className=""
            ...
            >
              <StaticImage
                placeholder="blurred"
                alt="Arrow steps"
                src="../../images/bootcamp/arrow-steps.png"
            ...
            <div className={`d-flex justify-content-center`}>
              <StaticImage
                placeholder="blurred"
                alt="Basic challenges"
                src="../../images/bootcamp/basic-challenge.png"
                className=""
                style={{ maxWidth: "180px" }}
              />
            </div>
            ...
            <div className={`d-flex justify-content-center`}>
              <StaticImage
                placeholder="blurred"
                alt="in person interview"
                src="../../images/bootcamp/in-person-interview.png"
                className=""
                style={{ maxWidth: "180px" }}
              />
            </div>
            ...
            <div className={`d-flex justify-content-center`}>
              <StaticImage
                placeholder="blurred"
                alt="Figure it out challenge"
                src="../../images/bootcamp/fio-challenge.png"
                className=""
                style={{ maxWidth: "180px" }}
              />
            </div>
          ...
          <Row>
            <Col>
              ...
              <Title className="text-center text--small fw-bold fst-italic">
                {" "}
                Guarantees open spots for next class
              </Title>
            </Col>
          </Row>
          <Row>
            <Col
              ...
              lg={3}
              xl={3}
              className={` ${styles.bootcampUpcomingdates} text-center ms-auto my-4 d-none d-sm-block`}
            >
              {" "}
              {/*Hidden on mobile*/}
              <Title className="text-center text--medium fw-bolder">
                {data.sanityBootcamp.previousStartDate}
              </Title>
              <h4>TO</h4>
              <Title className="text-center text--medium fw-bolder">
                {data.sanityBootcamp.previousEndDate}
              </Title>
              <BrandButton className="secondary btn--small my-2" disabled="">
                APPLICATIONS CLOSED
              </BrandButton>
            </Col>
        ...
        <Container className={`${styles.timeline} pt-5 justify-content-center`}>
          ...
          <Col sm={12} md={12} lg={12} xl={9}>
            ...
            <Row className="">
              <img
                style={{ maxWidth: "" }}
                className="text-center pl-2 mb-3"
                src={require("/src/images/bootcamp/timeline.png").default}
                alt=""
              />
            </Row>
          </Col>
            ...
            <Col>
              ...
              <Row>
                  ...
                  <Row>
                    <div className="text-center">
                      <img
                        ...
                        src={require("/src/images/bootcamp/cost.png").default}
                        alt="Piggy Bank"
                      />
                    </div>
                  </Row>
                  <Row>
                    <Title className="text-center py-4 fs-3 text--medium">
                ...
                <Col>
                  ...
                  <Row className="">
                    <Title className="text-center py-4 ms-auto text--medium">
                      Up-Front Payment
                    </Title>
                  </Row>
                  <Row className="mx-5">
