...
function FAQCard({ question, answer }) {
  ...
  return (
    <div className={`${styles.outerBox} align-items-center mb-4`}>
      ...
      <p className={styles.innerText}>{answerParagraphs}</p>
    </div>
  );
}
...
const QRCodePage = () => {
  return (
    <Layout>
          ...
          <Row className="d-flex flex-row align-items-center">
            <Col className="d-flex justify-content-center text-center">
              <div className={styles.heading}>
                <Title
                  className={`${styles.headingTitle} text-uppercase text-grey mt-5`}
                >
      ...
      {/* Wifi */}
      <Container
        className={`${styles.wifiContainer} d-flex justify-content-center text-center`}
      >
        <Col>
      ...
      <section className={`${styles.conferenceImage} pt-5 pb-5`}>
        <Container className={styles.conferenceContainer}>
          <Row className="d-flex align-items-center justify-content-center text-center">
            <Col>
              <Title className="text-white">
                NEED TO HOP IN A CONFERENCE ROOM?
              </Title>
              <p
                className="text-white mt-3"
                style={{ fontWeight: "bold", fontStyle: "italic" }}
              >
                Click on a conference room for availability.
              </p>
            </Col>
          </Row>
          <Row className="d-flex align-items-center justify-content-center text-center text-white ms-auto mt-3">
            <Col lg={3} md={6}>
              <a
                href="https://calendar.google.com/calendar/u/0?cid=YXYxcnNwdTljbnNvdHUwdGNkbmNvY3FzZWdAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ"
                target="_blank"
              >
                <Image
                  src={people}
            ...
            <Col lg={3} md={6}>
              <a
                href="https://calendar.google.com/calendar/u/0?cid=bzd2aG11czlyYzRxOHJlM240am1oZ3Y5bWtAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ"
                target="_blank"
              >
                <Image
                  src={thinkingRoom}
                  alt="Upstairs Thinking Room"
                  className={styles.conferenceLogo}
                />
                <h3>Upstairs</h3>
                <br />
            ...
            <Col lg={3} md={6}>
              <a
                href="https://calendar.google.com/calendar/u/0?cid=bzVhcWE2OHE1MjdoZHQyb2dybm82bTc3cWNAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ"
                target="_blank"
              >
                <Image
                  src={cv3}
            ...
            <Col lg={3} md={6}>
              <a
                href="https://calendar.google.com/calendar/u/0?cid=cGdiZWczZTVsdXE5ZDBtYTNmMzI2czRnMWNAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ"
                target="_blank"
              >
                <Image
                  src={table}
      ...
      <Container className="justify-content-center text-center pt-5 pb-5">
        <Row>
          <Col>
            <Title className="pb-3" style={{ color: "#C02129" }}>
              Still need help?
            </Title>
            <Subtitle className="pb-5">
              Click on a name or photo to email someone on our Space team.
            </Subtitle>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col xs="auto" className="text-center">
            <a href="mailto:conner.jones@awesomeinc.org">
              ...
              <Subtitle
                className="pt-3 pb-4"
                style={{ fontWeight: "bold", color: "#C02129" }}
              >
                Conner Jones
              </Subtitle>
            </a>
      ...
      {/*Calendar*/}
      <section
        className={`${styles.calendar} d-flex justify-content-center text-center`}
      >
        <Container>
          <Image src={calendar} alt="Calendar" />
          <p className="text-white mt-4 mb-4" style={{ fontWeight: "bold" }}>
            Take a look to see what's coming up
          </p>
          <a href="/events/">
      ...
      <section className={`d-flex justify-content-center pt-5 pb-5`}>
        <Col>
          ...
          <FAQCard
            ...
            answer={[
              "Yes, our electric scooters are available for our members to use. Before you take your first ride, ",
              <a href="https://forms.zohopublic.com/virtualoffice9155/form/ScooterWaivers/formperma/V2_zgVNBVALYUJW-2NB4pxP5Ni1-u_g5xzHjvZ3zfwk">
                please fill out a waiver form
              </a>,
              ". Upon your return, please plug scooters back into their chargers at their parking station.",
            ]}
          />
          <FAQCard
