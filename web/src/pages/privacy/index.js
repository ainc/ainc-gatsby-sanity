    ...
    <Container>
      <section className="col-sm-offset-2">
        ...
        <p style={{fontSize: "16px"}}>
            ...
            The following policy explains our information collection practices, privacy policies and the choices available         
        ...
        <div className="list">
          <ul>
            <li>Personal information you provide to us, including, but not limited to, your name, age, date of birth, 
              address, e-mail address, credit card number and facts about your background, profession, and similar information.</li>
            <li>Information regarding your interaction with our Site, including, but not limited to, your IP address, device type, 
              geographic location information, computer and connection information, statistics on page views, traffic to and from 
              our Site, and web log information.</li>
            <li>Information you provide to us through community discussions, member information pages, e-mails, chats, dispute resolution, 
              or information you share with us through other social applications or websites.</li>
            <li>We may use cookies, web beacons, pixel tags, log files, or other technologies to collect certain information about 
              visitors to and users of our Site. For example, we may automatically collect certain information such as the type of web 
              browser and operating system you use, the name of your Internet Service Provider, Internet Protocol address, etc. Cookies 
              do not extract personal data about you, like your name or e-mail address. We use this information to monitor and improve our
               Site, personalize your online experience, and for internal analysis. You may block the installation of our cookies by changing 
               the setting on your browser. However, if your browser does not accept cookies, certain areas of the website may not function properly. 
               Some third-party merchants and advertisers also use cookies. Because we do not control the privacy policies of third-party 
               merchants, advertisers or any other sites to which we may provide hyperlinks, you should check the privacy policy of the site 
        ...
        <div className="list">
          <ul>
            ...
            <li>To contact you regarding the status of your transaction or to send you e-mail notifications about our products, services and 
              special offers, or to otherwise contact you.</li>
            <li>To enhance existing features or develop new features, products and services.</li>
            <li>In the event of a sale, merger, bankruptcy or other change in control of Awesome Ventures, LLC, your information may be shared 
              with the person or business that owns or controls this Site. Opting out of receiving information from third parties will not affect
               our right to transfer your information to a new owner.</li>
            <li>If required to do so by law or in the good faith belief that such action is necessary to conform to the edicts of the law or 
              comply with a judicial proceeding, court order or legal process or to protect and defend the rights or property of Awesome Ventures,
        ...
        <p style={{fontSize: "16px"}}>We endeavor to safeguard and protect your personal information. We have implemented technical and organizational measures to secure your personal 
          information. Although we take measures to protect against unauthorized disclosures of information, no method of transmission over the Internet, or
           ...
           be disclosed in a manner that is inconsistent with this Privacy Policy.</p>
        <div className="list">
          <ul>
            <li>Credit Card Information: For you convenience, you may have us bill you or you can pay for orders by credit card. For you security, your credit 
              card number is not stored in our system. We use encryption technology to safeguard and protect your personal information and transactions over the internet. 
              Your information, including your credit card information, is encrypted and cannot be read as it travels over the Internet.</li>
            <li>E-mail Addresses: Except as may be required by law, or to comply with a judicial proceeding, court order or legal process, we will not share your e-mail address 
              with third parties, although we reserve the right to present you with advertisements on their behalf.</li>
            <li>Agents and Service Providers: We employ other companies and individuals to perform functions on our behalf. Examples include payment processing, enabling instructors 
              to answer your requests, sending postal mail and e-mail, removing repetitive information from customer lists, analyzing data, providing marketing assistance, and 
              providing customer service. These agents have access to personal information needed to perform their functions, but are contractually prohibited from using it for other purposes.</li>
        ...
        <div className="list">
          <ul>
            <li>Links: Our Site may contain links to other sites whose privacy practices may differ from ours. Such third-party sites are not under our control and have separate and independent privacy policies. 
              We encourage you to read the privacy statements of each website. We are not responsible for the privacy practices or the content of such sites.</li>
            <li>Public Forums: Our Site may make chat rooms, forums, message boards and/or news groups available to the users. Please remember that anyone may read postings 
              on a forum or in a chat room and such postings become public information. Such information can be collected and used by others besides Awesome Ventures, LLC and 
              its affiliates. We cannot be responsible for any unauthorized third party’s use of information that you disclose online.</li>
          </ul>
        </div>
        <p style={{fontSize: "16px"}}>We may produce contests, sweepstakes, special events or other offerings with the support of promotional partners. Personal information collected by our Site in conjunction with such offerings may also be
