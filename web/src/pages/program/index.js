    ...
    <Layout>
      ...
      <section id="teams">
        <Container className={styles.tonightsTeams}>
          <Subtitle className="text-center my-5 text-black text-uppercase">
            Tonight's Teams
          </Subtitle>
          <Col xs={12}>
            {teams.map((team) => (
      ...
      <section id="judges">
        <Container className={styles.tonightsJudges}>
          <Subtitle className="text-center text-uppercase text-white pt-4 pb-2 mt-3">
            Tonight's Judges
          </Subtitle>
        ...
        <Container>
          <Row>
            <Col xs={{ offset: 2, span: 10 }} md={{ offset: 1, span: 12 }}>
              <StaticImage
                placeholder="blurred"
                className="my-4 mw-100 w-75"
                src="../../images/5across-banner.png"
              ></StaticImage>
            </Col>
          </Row>
          <Row>
            <Subtitle className="text-uppercase fw-bold text-center mb-3">
              Thanks its sponsors
            </Subtitle>
          </Row>
          <Row>
      ...
      <section id="podcasts">
        <Container className={styles.experienceMore}>
          <Row>
            <Col xs={12} md={12}>
              <Title className="text-uppercase text-white text-center mt-4">
          ...
          <Row>
            <Col xs={{ offset: 2, span: 8 }} md={{ offset: 4, span: 12 }}>
              <StaticImage
                placeholder="blurred"
                className="my-4"
                src="../../images/5across-logo-white.png"
              ></StaticImage>
            </Col>
          </Row>
      ...
      <section id="mentor">
        <Container className={styles.becomeMentor}>
          <Col xs={12}>
            <Subtitle className="fw-bold my-5 brand text-center text-uppercase">
