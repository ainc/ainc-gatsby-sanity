...
const Blog = ({ pageContext }) => {
  ...
  const authorImage = getImage(
    blogInfo.reference.picture.asset.gatsbyImageData,
  );
      ...
      <Container>
        <Row>
          <Col sm={{ span: 8, offset: 2 }}>
            ...
            <BrandButton
              className="text-uppercase px-2 py-0 py-sm-1"
              onClick={handleShow}
            >
              Notify Me
            </BrandButton>
              ...
              content={
                ...
                <Container fluid>
                  ...
                  >
                    ...
                    <Subtitle>
                      You'll receive a monthly email with new blog info.
                    </Subtitle>
                    <Row>
                      {/*<!--Name-->*/}
            ...
            <SocialMediaIcons
              text={`${blogInfo.title} | Awesome Inc`}
              link={`https://www.awesomeinc.org/blog/${blogInfo.slug.current}`}
            />
            ...
            <Container>
              <FacebookProvider appId="405237331509908">
                <Comments
                  href={`https://www.awesomeinc.org/blog/${blogInfo.slug.current}`}
                />
              </FacebookProvider>
            </Container>
          </Col>
