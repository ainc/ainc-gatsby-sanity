                        ...
                        <Container className='my-4'>
                                <Row className=''>
                                    <Col xs={{ span: 2}} sm={{span:1}} className="d-flex justify-content-center p-0 rounded-circle border border-1 border-dark">
                                        <GatsbyImage objectFit='cover' image={blogInfo.reference.picture?.asset.gatsbyImageData || '../../images/ainc-logo-horizontal-white-text.png' } alt={blogInfo.reference.name} className="rounded-circle border border-3 border-white p-1"/>
                                    </Col>
